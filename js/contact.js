CV = {
    contact: {
        ...
        links: [{
            ...
            icon: "img/email.svg",
            color: "#0C9688",
            href: "mailto:sun515@purdue.edu",
            size: 56
        }, {
            name: "Facebook",
            icon: "img/Facebook.png",
            size: 28,
            href: "https://www.facebook.com/zhaoya.sun",
            color: "#3B5999"
        }, {
            name: "Github",
            icon: "img/github.svg",
            size: 28,
            href: "https://github.com/claudiazhaoya",
            color: "#0A0F19"
        }, {
            name: "Quora",
            icon: "img/quora.svg",
            size: 28,
            href: "https://www.quora.com/profile/Zhaoya-Sun/activity",
            color: "#b72d2c"
        }, {
            name: "Snapchat",
            ...
            href: "https://twitter.com/Claudia_Zhaoya",
            size: 28,
            color: "#4099FF"
        }
        ],
